...
myKeys conf@(XConfig {XMonad.modMask = modMask}) =
    ...
    ( autoremoveEmptyWorkspaces
      ...
      , ("M-<KP_End>"                , spawn "xrandr --output eDP1 --auto")
      , ("M-S-<KP_End>"              , spawn "xrandr --output eDP1 --off")
      , ("M-<KP_Down>"               , spawn "xrandr --output VIRTUAL2 --mode VIRTUAL2.544-3840x2160")
      , ("M-S-<KP_Down>"             , spawn "xrandr --output VIRTUAL2 --off")
      , ("M-C-S-<KP_Down>"           , spawn "xrandr --output VIRTUAL2 --auto")
