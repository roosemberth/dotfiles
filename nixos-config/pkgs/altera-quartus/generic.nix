...
let
  ...
  glibcPatchFilter = builtins.filter
    (x: ((builtins.match ".*fix-i686-memchr.patch" (builtins.toString x)) == null)
     && ((builtins.match ".*2.26-75.patch.gz" (builtins.toString x)) == null)
     && ((builtins.match ".*2.26-75to115.diff.gz" (builtins.toString x)) == null)
     && ((builtins.match ".*2.26-115to131.diff.gz" (builtins.toString x)) == null)
     );
